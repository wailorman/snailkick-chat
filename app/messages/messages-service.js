define(
    ...
    function ( app, async ) {
        return app
            .service( 'messagesService', function ( $rootScope, apiService, authService, clientsService, $q, boxStateService, userClientService ) {
            ...
            .service( 'boxStateService', function ( $rootScope, userTokenService, userClientService, apiService ) {
